...
The store holds your app’s state. Actions send data to your store with `dispatch()`. Reducers update store state. The store is available to any component you `connect()` it to.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application state is global, Component state is localized. If a lot of state needs to be shared amongst many components then Application state is the way to go.

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

Middleware that looks for action functions. Allows for asynchronous operations like async.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

Context API, I don’t like all the boilerplate with Redux.
